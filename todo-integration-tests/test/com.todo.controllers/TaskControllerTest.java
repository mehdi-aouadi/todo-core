...
public class TaskControllerTest extends JerseyTest {
    ...
    public void testIt() {
        ...
        Response postResponse = target("todo/tasks")
                .request()
                .post(taskContentEntity);

        Assert.assertEquals(200, postResponse.getStatus());

        Response response = target("todo/tasks/assigned")
        ...
        Assert.assertTrue(taskContentListAfterPost.contains(taskContentForPost));
    }
}
